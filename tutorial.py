...
from tutorial_npc_2_dialogue import handle_npc_2_dialogue  # Import the NPC dialogue functionality
from tutorial_npc_3_dialogue import handle_npc_3_dialogue  # Import the NPC dialogue functionality
