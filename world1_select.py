...
background_image = pygame.image.load("Accessories/menu_level1_selector_background.jpg")
...
level_preview = pygame.image.load("Accessories/level1_selector_background.png")  # Load image
...
current_level_image = pygame.image.load("Accessories/current_snow_level_button.png")  # Replace with your image file
...
mini_squares = [
    {"pos": (level_rect.centerx - 150, level_rect.centery - 80), "image": unlocked_level_image},  # Top left position
    {"pos": (level_rect.centerx + 10, level_rect.centery - 20), "image": current_level_image},    # Middle position
    {"pos": (level_rect.centerx - 140, level_rect.centery + 70), "image": unlocked_level_image},  # Current position
    {"pos": (level_rect.centerx + 157, level_rect.centery - 35), "image": unlocked_level_image},  # Middle right position
    {"pos": (level_rect.centerx + 110, level_rect.centery + 150), "image": locked_level_image},   # Bottom right position
]
