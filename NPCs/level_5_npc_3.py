...
dialogue_lines = [
    ...
    "So thirsty...",
    "I don't care about the storm, I just want some water.",
    "After this sip from the river, I'll be ready to go.",
]
...
def handle_level_5_npc_3_dialogue(screen, player_rect, npc_rect, keys, current_time):
    """
