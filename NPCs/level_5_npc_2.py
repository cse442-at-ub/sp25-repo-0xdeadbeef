...
dialogue_lines = [
    ...
    "I can feel the sand kicking against my skin.",
    "Luckily enough, these balloons can get you to the air and fly along the direction of the wind.",
    "Hang tight, but get as close to the edge as you can.",
    "Or else the balloons might inflate mid-air and drop you to the ground.",
...
def handle_level_5_npc_2_dialogue(screen, player_rect, npc_rect, keys, current_time):
    """
