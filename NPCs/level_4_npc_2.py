...
dialogue_lines = [
    ...
    "You're half way through the area!",
    "Keep moving forward and watch where you're jumping!",
    "You'll be able to see the exit soon!",
]
...
def handle_level_4_npc_2_dialogue(screen, player_rect, npc_rect, keys, current_time):
    """
