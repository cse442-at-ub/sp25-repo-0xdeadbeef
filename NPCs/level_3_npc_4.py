...
dialogue_lines = [
    ...
    "Well now, a new visitor to the town!",
    "I hope you find our place hospitable enough since we're living in the middle of nowhere.",
    "Oh, my name is Rivel, I'm the mayor of this town.",
    "Would you like a place to stay in this peaceful place?",
    "Young men like you can really make this town a lot more lively.",
    "Hell, we'd be breaking our backs if we don't even have one. Hahaha!",
    "Oh, you want to leave already?",
    "I can't stop you from leaving now, can I?",
    "If you want to find another area to explore, you should head to the desert beyond this mountain.",
    "There's some folks there who can help you with finding a place to settle.",
    "But, if you ever want to come back, you know where to find me.",
    "We'll always open our doors to anyone that helps our town.",
...
def handle_level_3_npc_4_dialogue(screen, player_rect, npc_rect, keys, current_time):
    """
