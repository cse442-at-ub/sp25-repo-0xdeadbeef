...
dialogue_lines = [
    ...
    "Just keep running and stay calm!",
    "I don't wanna see you slip and fall before the snow buries you alive."
]
...
def handle_level_4_npc_3_dialogue(screen, player_rect, npc_rect, keys, current_time):
    """
