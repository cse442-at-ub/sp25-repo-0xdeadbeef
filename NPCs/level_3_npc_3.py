...
dialogue_lines = [
    ...
    "If you feeling lost, don't give up.",
    "I felt my own downfall many times before.",
    "You know what you need right now?",
    "Time.",
    "Yup, just take some time and think about how to get across this place with the resources you have.",
    "It's tricky, but with enough brain power, you'll find a way.",
]
...
def handle_level_3_npc_3_dialogue(screen, player_rect, npc_rect, keys, current_time):
    """
