...
dialogue_lines = [
    ...
    "Woah, slow down man!",
    "There's ice all over the place here.",
    "You don't have any ice boots, do you?",
    "Then you should be careful when walking on the ice.",
...
def handle_level_2_npc_3_dialogue(screen, player_rect, npc_rect, keys, current_time):
    """
