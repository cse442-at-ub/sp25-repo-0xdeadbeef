...
dialogue_lines = [
    ...
    "Phew! Rough storm isn't it?",
    "The wind is winding down, but it's good enough to glide the sky.",
    "There should be a glider around here somewhere.",
    "You should try riding it.",
    "Imagine how cool it is to fly like a bird!",
]
...
def handle_level_6_npc_2_dialogue(screen, player_rect, npc_rect, keys, current_time):
    """
