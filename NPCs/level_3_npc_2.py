...
dialogue_lines = [
    ...
    "If you want to talk about a place to stay around here, you should talk to the mayor of this town.",
    "He should be at the end of this road, just across the bridge.",
    "I'm sure he'll give you a place to stay.",
    "Though, with all the terrain around here, I doubt that you'll want to stay here.",
    "I heard that there's a desert not so far away from here.",
    "It's sweltering hot, but it's a decent place to stay.",
...
def handle_level_3_npc_2_dialogue(screen, player_rect, npc_rect, keys, current_time):
    """
