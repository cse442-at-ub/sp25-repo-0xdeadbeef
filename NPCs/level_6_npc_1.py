...
dialogue_lines = [
    ...
    "There should be a red button in that cave in front of us.",
    "I ain't going in there though.",
    "That place is crawling with spikes and pits.",
    "But I heard that it unlocks a secret passage.",
...
def handle_level_6_npc_1_dialogue(screen, player_rect, npc_rect, keys, current_time):
    """
