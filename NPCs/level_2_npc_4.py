...
dialogue_lines = [
    ...
    "Quick, come in!",
    "The storm is coming!",
    "Or move to the next area!",
    "You should be able to avoid the storm over there.",
]
...
def handle_level_2_npc_4_dialogue(screen, player_rect, npc_rect, keys, current_time):
    """
